...
import { publicationsPublicRouter } from '@/modules/dashboard/reports/publications/publications.public.routes';
...
apiRouter.use('/public/reports', publicationsPublicRouter);
