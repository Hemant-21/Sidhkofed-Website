...
export const metadata: Metadata = buildMetadata({
  title: 'Policies, Guidelines & SOPs',
  description: 'Policy documents, operational guidelines and standard operating procedures from SIDHKOFED.',
  path: '/publications/policies-guidelines-sops',
});

type SP = Record<string, string | string[] | undefined>;

export default async function PoliciesGuidelinesPage({ searchParams }: { searchParams: SP }) {
  ...
  return (
    <ListingLayout
      titleKey="page.publications.policies.title"
      subtitleKey="page.publications.policies.subtitle"
      crumb="Policies, Guidelines & SOPs"
