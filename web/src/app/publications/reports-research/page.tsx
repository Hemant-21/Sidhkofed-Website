...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'Annual reports, research studies and impact assessments from SIDHKOFED.',
  path: '/publications/reports-research',
});

type SP = Record<string, string | string[] | undefined>;

export default async function ReportsResearchPage({ searchParams }: { searchParams: SP }) {
  ...
  return (
    <ListingLayout
      titleKey="page.publications.reports.title"
      subtitleKey="page.publications.reports.subtitle"
      crumb="Reports & Research"
