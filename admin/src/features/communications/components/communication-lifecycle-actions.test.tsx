...
import { CommunicationLifecycleActions } from './communication-lifecycle-actions';
...
function renderAs(role: keyof typeof ROLE_FIXTURES, comm: Partial<CommunicationDetail> = {}) {
  ...
  const detail = { id: 'c1', publication_state: 'draft', ...comm } as CommunicationDetail;
  ...
  return render(
    <QueryClientProvider client={client}>
      <AuthContext.Provider value={auth}>
        <ToastProvider>
          <DialogProvider>
            <CommunicationLifecycleActions communication={detail} />
          </DialogProvider>
        </ToastProvider>
