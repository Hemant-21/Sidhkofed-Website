...
import { ProcurementLifecycleActions } from './procurement-lifecycle-actions';
...
function renderAs(role: keyof typeof ROLE_FIXTURES, proc: Partial<ProcurementDetail> = {}) {
  ...
  const detail = { id: 'p1', publication_state: 'draft', ...proc } as ProcurementDetail;
  ...
  return render(
    <QueryClientProvider client={client}>
      <AuthContext.Provider value={auth}>
        <ToastProvider>
          <DialogProvider>
            <ProcurementLifecycleActions procurement={detail} />
          </DialogProvider>
        </ToastProvider>
