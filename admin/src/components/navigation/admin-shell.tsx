...
export function AdminShell({ children }: { children: ReactNode }) {
  ...
  return (
    // SearchProvider owns the global Ctrl/Cmd+K command palette for the authenticated
    // shell, so search is reachable from the topbar, the dashboard, and the keyboard.
    <SearchProvider>
